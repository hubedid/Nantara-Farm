...
function Dashboard() {
  ...
  useEffect(() => {
    ...
    if(currentMonth === 9){
      newMonthData = [0.40756, 0.44555, 0.48294, 0.58321, 0.65428, 0.69605, 0.77584, 0.78032, 0.85503, 0.9326, 1.02061, 1.08439, 1.19447, 1.22457, 1.2540, 1.2713, 1.2984, 1.30731, 1.29983, 1.30043, 1.3165, 1.3207, 1.3211, 1.32794, 1.331, 1.33571, 1.3409, 1.33004, 1.35106, 1.35118, 1.3612]
      setGraphData(newMonthData)
